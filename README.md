...
1. Copy the following HTML code into your project's `<body>` section:
...
<body>
    <menu class="menu">
        ...
        <button class="menu__item active">
            ...
            <strong class="menu__text active"><a href="https://apkodu.com/" class="apkodu">home</a></strong>
        </button>
        ...
        <button class="menu__item">
            ...
            <strong class="menu__text"><a href="https://apkodu.com/" class="apkodu">strategy</a></strong>
        </button>
        ...
        <button class="menu__item">
            ...
            <strong class="menu__text"><a href="https://apkodu.com/" class="apkodu">period</a></strong>
        </button>
        ...
        <button class="menu__item">
            ...
            <strong class="menu__text"><a href="https://apkodu.com/" class="apkodu">security</a></strong>
        </button>
...
3. Customize the navbar according to your website's design and theme.
